...
#define BLKADDR_AFFINITY(A, type, m, n)  (type *)plasma_getaddr_affinity(A, m, n)
...
void plasma_pdtile_to_lapack_affinity_quark(PLASMA_desc, double*, int, PLASMA_sequence *sequence, PLASMA_request *request);
...
void plasma_pdlapack_to_tile_affinity_quark(double*, int, PLASMA_desc, PLASMA_sequence *sequence, PLASMA_request *request);
...
void plasma_pdtile_zero_affinity_quark(PLASMA_desc, PLASMA_sequence *sequence, PLASMA_request *request);
