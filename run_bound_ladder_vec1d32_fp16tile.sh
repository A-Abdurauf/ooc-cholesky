...
SWEEP_DIR="$OUT_DIR/bound_ladder_vec1d32_fp16tile"
RUN_LOG_DIR="$SWEEP_DIR/run_logs"
SUMMARY_FILE=${SUMMARY_FILE:-"$SWEEP_DIR/summary_bound_ladder_vec1d32_fp16tile.tsv"}
...

{
  ...
  echo "[CFG] mode=vec1d subtile=32 ladder=full(custom: e2m1->mx_e4m3->mx_fp16->fp32) MX_MODE_FP16=tile"
