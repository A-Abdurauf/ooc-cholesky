#!/usr/bin/env python3
"""Paper-grade figure: lowmidscale (Low + Mid scaled) at N=32768, granularity
...
subnormal swing within the Low+Mid-scaled (MX_FP16 mid + MX_E4M3 low; FP32 plain) family.
"""
import argparse
import csv
...
GRANS = [
    ("tile",        "#f28e2b",  # orange
     ...
     "requant_lowmidscale_tile_FTZ_gt20k"),
    ("block-128",   "#59a14f",  # green
     "requant_lowmidscale_block128_gt20k",
     "requant_lowmidscale_block128_FTZ_gt20k"),
    ("MX",   "#b07aa1",  # purple
     "requant_lowmidscale_vec1d32_gt20k",
     "requant_lowmidscale_vec1d32_FTZ_gt20k"),
]
...
def main():
    ...
    ax.set_title(f"Low + Mid scaled (MXFP16 mid + MXFP8 low; FP32 plain)  ·  N={args.n}, NB=2048")
    if y_min < float("inf"):
