...
#ifdef PLASMA_WITH_CUDA
int PLASMA_dpotrf_gpu_async_copy(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_no_free(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_static_table(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_dist(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_dist(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_dist(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_table_no_free_dist(PLASMA_enum uplo, int N, double *A, int LDA);
int PLASMA_dpotrf_gpu_reuse_data_static_table_dist(PLASMA_enum uplo, int N, double *A, int LDA);
#endif
#endif
...
#ifdef PLASMA_WITH_HPCASIA24
#ifdef PLASMA_WITH_CUDA
int PLASMA_dpotrf_gpu_async_copy_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_no_free_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_static_table_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_dist_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_dist_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_dist_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_table_no_free_dist_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dpotrf_gpu_reuse_data_static_table_dist_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence, PLASMA_request *request);
#endif
#endif
