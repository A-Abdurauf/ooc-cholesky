...
int PLASMA_dpotrf_gpu_reuse_data_mixed_precision_dist(PLASMA_enum uplo, int N,
                                                      double *A, int LDA) {
  int NB;
  int status;
  ...
  PLASMA_dpotrf_gpu_reuse_data_mixed_precision_dist_Tile_Async(
...
int PLASMA_dpotrf_gpu_reuse_data_table_mixed_precision_dist(PLASMA_enum uplo,
                                                            int N, double *A,
                                                            int LDA) {
  int NB;
  int status;
  ...
  /* Call the tile interface */
  PLASMA_dpotrf_gpu_reuse_data_table_mixed_precision_dist_Tile_Async(
      uplo, &array, sequence, &request);
...
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist(
  ...
  /* Call the tile interface */
  PLASMA_dpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist_Tile_Async(
      uplo, &array, sequence, &request);
 ...
 *
 ******************************************************************************/
int PLASMA_dpotrf_gpu_reuse_data_mixed_precision_dist_Tile(PLASMA_enum uplo,
                                                           PLASMA_desc *A) {
  plasma_context_t *plasma;
  PLASMA_sequence *sequence = NULL;
  PLASMA_request request = PLASMA_REQUEST_INITIALIZER;
...
int PLASMA_dpotrf_gpu_reuse_data_table_mixed_precision_dist_Tile(
  ...
  plasma_sequence_create(plasma, &sequence);
  PLASMA_dpotrf_gpu_reuse_data_table_dist_Tile_Async(uplo, A, sequence,
                                                     &request);
  plasma_dynamic_sync();
  status = sequence->status;
  plasma_sequence_destroy(plasma, sequence);
...
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist_Tile(
    PLASMA_enum uplo, PLASMA_desc *A) {
  plasma_context_t *plasma;
  PLASMA_sequence *sequence = NULL;
  PLASMA_request request = PLASMA_REQUEST_INITIALIZER;
  ...
  plasma_sequence_create(plasma, &sequence);
  PLASMA_dpotrf_gpu_reuse_data_table_all_managed_dist_Tile_Async(
...
int PLASMA_dpotrf_gpu_reuse_data_mixed_precision_dist_Tile_Async(
  ...
  */
  plasma_parallel_call_4(plasma_pdpotrf_gpu_reuse_data_mixed_precision_dist,
...
int PLASMA_dpotrf_gpu_reuse_data_table_mixed_precision_dist_Tile_Async(
    PLASMA_enum uplo, MixedPrecisionTiledArray *A, PLASMA_sequence *sequence,
    PLASMA_request *request) {
  MixedPrecisionTiledArray descA;
  plasma_context_t *plasma;
  ...
  */
  plasma_parallel_call_4(
      plasma_pdpotrf_gpu_reuse_data_table_mixed_precision_dist, PLASMA_enum,
      uplo, MixedPrecisionTiledArray, descA, PLASMA_sequence *, sequence,
      PLASMA_request *, request);
  return PLASMA_SUCCESS;
}

int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist_Tile_Async(
    PLASMA_enum uplo, MixedPrecisionTiledArray *A, PLASMA_sequence *sequence,
    PLASMA_request *request) {
  MixedPrecisionTiledArray descA;
  plasma_context_t *plasma;
  ...
  */
  plasma_parallel_call_4(
      plasma_pdpotrf_gpu_reuse_data_table_all_managed_mixed_precision_dist,
      PLASMA_enum, uplo, MixedPrecisionTiledArray, descA, PLASMA_sequence *,
      sequence, PLASMA_request *, request);
  return PLASMA_SUCCESS;
}

// int PLASMA_dpotrf_gpu_reuse_data_table_no_free_dist_Tile_Async(
...
//                          PLASMA_enum, uplo, PLASMA_desc, descA,
//                          PLASMA_sequence *, sequence, PLASMA_request *,
//                          request);
//   return PLASMA_SUCCESS;
// }
//
// int PLASMA_dpotrf_gpu_reuse_data_static_table_dist_Tile_Async(
//     PLASMA_enum uplo, PLASMA_desc *A, PLASMA_sequence *sequence,
//     PLASMA_request *request) {
//   PLASMA_desc descA;
//   plasma_context_t *plasma;
