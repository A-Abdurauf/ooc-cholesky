...
int PLASMA_dpotrf_gpu_reuse_data(PLASMA_enum uplo, int N,
                                 double *A, int LDA)
{
    int NB;
    int status;
    ...
    /* Call the tile interface */
    PLASMA_dpotrf_gpu_reuse_data_Tile_Async(uplo, &descA, sequence, &request);
...
int PLASMA_dpotrf_gpu_reuse_data_table(PLASMA_enum uplo, int N,
                                 double *A, int LDA)
{
    int NB;
    int status;
    ...
    /* Call the tile interface */
    PLASMA_dpotrf_gpu_reuse_data_table_Tile_Async(uplo, &descA, sequence, &request);
...
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed(PLASMA_enum uplo, int N,
                                 double *A, int LDA)
{
    int NB;
    int status;
    ...
    /* Call the tile interface */
    PLASMA_dpotrf_gpu_reuse_data_table_all_managed_Tile_Async(uplo, &descA, sequence, &request);
...
int PLASMA_dpotrf_gpu_reuse_data_table_no_free(PLASMA_enum uplo, int N,
                                               double *A, int LDA)
{
    int NB;
    int status;
    ...
    /* Call the tile interface */
    PLASMA_dpotrf_gpu_reuse_data_table_no_free_Tile_Async(uplo, &descA, sequence, &request);
...
int PLASMA_dpotrf_gpu_reuse_data_static_table(PLASMA_enum uplo, int N,
                                              double *A, int LDA)
{
    int NB;
    int status;
    ...
    /* Call the tile interface */
    PLASMA_dpotrf_gpu_reuse_data_static_table_Tile_Async(uplo, &descA, sequence, &request);
...
int PLASMA_dpotrf_gpu_async_copy_Tile(PLASMA_enum uplo, PLASMA_desc *A)
{
    ...
    plasma_sequence_create(plasma, &sequence);
    PLASMA_dpotrf_gpu_async_copy_Tile_Async(uplo, A, sequence, &request);
    plasma_dynamic_sync();
    status = sequence->status;
    plasma_sequence_destroy(plasma, sequence);
    return status;
...
int PLASMA_dpotrf_gpu_reuse_data_table_Tile(PLASMA_enum uplo, PLASMA_desc *A)
{
    ...
    plasma_sequence_create(plasma, &sequence);
    PLASMA_dpotrf_gpu_reuse_data_table_Tile_Async(uplo, A, sequence, &request);
    plasma_dynamic_sync();
    status = sequence->status;
    plasma_sequence_destroy(plasma, sequence);
    return status;
...
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_Tile(PLASMA_enum uplo, PLASMA_desc *A)
{
    ...
    plasma_sequence_create(plasma, &sequence);
    PLASMA_dpotrf_gpu_reuse_data_table_all_managed_Tile_Async(uplo, A, sequence, &request);
    plasma_dynamic_sync();
    status = sequence->status;
    plasma_sequence_destroy(plasma, sequence);
    return status;
...
int PLASMA_dpotrf_gpu_reuse_data_table_no_free_Tile(PLASMA_enum uplo, PLASMA_desc *A)
{
    ...
    plasma_sequence_create(plasma, &sequence);
    PLASMA_dpotrf_gpu_reuse_data_table_no_free_Tile_Async(uplo, A, sequence, &request);
    plasma_dynamic_sync();
    status = sequence->status;
    plasma_sequence_destroy(plasma, sequence);
    return status;
...
int PLASMA_dpotrf_gpu_reuse_data_static_table_Tile(PLASMA_enum uplo, PLASMA_desc *A)
{
    ...
    plasma_sequence_create(plasma, &sequence);
    PLASMA_dpotrf_gpu_reuse_data_static_table_Tile_Async(uplo, A, sequence, &request);
    plasma_dynamic_sync();
    status = sequence->status;
    plasma_sequence_destroy(plasma, sequence);
    return status;
...
int PLASMA_dpotrf_gpu_reuse_data_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A,
                                            PLASMA_sequence *sequence,
                                            PLASMA_request *request)
{
    PLASMA_desc descA;
    ...
    /*
        if (max(N, 0) == 0)
            return PLASMA_SUCCESS;
    */
    plasma_parallel_call_4(plasma_pdpotrf_gpu_reuse_data,
                           PLASMA_enum, uplo,
                           PLASMA_desc, descA,
                           PLASMA_sequence*, sequence,
                           PLASMA_request*, request);
...
int PLASMA_dpotrf_gpu_reuse_data_table_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A,
                                                  PLASMA_sequence *sequence,
                                                  PLASMA_request *request)
{
    PLASMA_desc descA;
    ...
    /*
        if (max(N, 0) == 0)
            return PLASMA_SUCCESS;
    */
    plasma_parallel_call_4(plasma_pdpotrf_gpu_reuse_data_table,
                           PLASMA_enum, uplo,
                           PLASMA_desc, descA,
                           PLASMA_sequence*, sequence,
                           PLASMA_request*, request);
...
int PLASMA_dpotrf_gpu_reuse_data_table_all_managed_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A,
                                                              PLASMA_sequence *sequence,
                                                              PLASMA_request *request)
{
    PLASMA_desc descA;
    ...
    /*
        if (max(N, 0) == 0)
            return PLASMA_SUCCESS;
    */
    plasma_parallel_call_4(plasma_pdpotrf_gpu_reuse_data_table_all_managed,
                           PLASMA_enum, uplo,
                           PLASMA_desc, descA,
                           PLASMA_sequence*, sequence,
                           PLASMA_request*, request);
...
int PLASMA_dpotrf_gpu_reuse_data_table_no_free_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A,
                                                          PLASMA_sequence *sequence,
                                                          PLASMA_request *request)
{
    PLASMA_desc descA;
...
int PLASMA_dpotrf_gpu_reuse_data_static_table_Tile_Async(PLASMA_enum uplo, PLASMA_desc *A,
                                                              PLASMA_sequence *sequence,
                                                              PLASMA_request *request)
{
    PLASMA_desc descA;
