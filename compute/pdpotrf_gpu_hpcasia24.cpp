...
void plasma_pdpotrf_gpu_reuse_data_static_table(plasma_context_t *plasma) {
  ...
  std::thread t_c2g{plasma_pdpotrf_gpu_reuse_data_static_table_c2g, rank,
                    rankDev, plasma};
  std::thread t_compute{plasma_pdpotrf_gpu_reuse_data_static_table_computation,
                        rank,
                        rankDev,
                        &current_step,
                        pBuffer,
 ...
 **/
void plasma_pdpotrf_gpu_async_copy_quark(PLASMA_enum uplo, PLASMA_desc A,
                                         PLASMA_sequence *sequence,
                                         PLASMA_request *request) {
...
void plasma_pdpotrf_gpu_reuse_data_quark(PLASMA_enum uplo, PLASMA_desc A,
                                         PLASMA_sequence *sequence,
                                         PLASMA_request *request) {
  printf("Dynamic scheduling is not supported yet\n");
  return;
...
void plasma_pdpotrf_gpu_reuse_data_table_quark(PLASMA_enum uplo, PLASMA_desc A,
                                               PLASMA_sequence *sequence,
                                               PLASMA_request *request) {
  printf("Dynamic scheduling is not supported yet\n");
  return;
...
void plasma_pdpotrf_gpu_reuse_data_table_all_managed_quark(
